...
if ( ! class_exists( 'Woocommerce_Catalog_Enquiry_Pro_License' ) ) {
    class Woocommerce_Catalog_Enquiry_Pro_License {
        ...
        public function __construct( $file, $plugin_path, $product_id, $software_version, $plugin_or_theme, $api_url, $software_title = '', $text_domain = '' ) {
			...
			if ( is_admin() ) {
                ...
                if ( ! empty( $this->plugin_or_theme ) && $this->plugin_or_theme == 'plugin' ) {
                    ...
                    update_option('mvx_Woocommerce_Catalog_Enquiry_installed', 1);
                }
                ...
                add_filter( 'mvx_enable_admin_script_screen_ids', array( $this, 'add_css_for_licence' ) );
                add_filter( 'mvx_license_tabs_list', array( $this, 'add_tab_item_for_licence' ) );
                ...
                $this->wc_am_activation_tab_key          = is_active_MVX() ? $this->data_key . '_dashboard' : 'woo-catalog-pro-license-activation';
                $this->wc_am_deactivation_tab_key        = is_active_MVX() ? $this->data_key . '_deactivation' : 'woo-catalog-pro-license-deactivation';
                ...
                $this->wc_am_licence_menu_slug			 = 'mvx-license-admin';
                ...
                // Load MVX Licence Admin Class
				if(!class_exists('Woocommerce_Catalog_Enquiry_Pro_License_Admin')) {
					require_once ( $this->plugin_path . 'classes/class-woocommerce-catalog-enquiry-pro-license-admin.php' );
					new Woocommerce_Catalog_Enquiry_Pro_License_Admin( $file, $product_id, $software_version, $plugin_or_theme, $api_url, $software_title = '', $text_domain = '' );
				}
            ...
            if ( $this->plugin_or_theme == 'plugin' ) {
                ...
                delete_option('mvx_Woocommerce_Catalog_Enquiry_installed');
            }
        ...
        public function add_css_for_licence( $screen_ids ) {
        	$screen_ids[] = 'mvx_page_mvx-license-admin';
        ...
        public function load_settings() {
            ...
            add_settings_section( 'deactivate_button', esc_html__( 'API Key Deactivation', $this->text_domain ), array(
                $this,
        ...
        public function catalog_enquiry_pro_licence_get_options(){
            /**
            * Create new menus
            */
            $woocommerce_catalog_options[ ] = array(
                "type" => "menu",
                "menu_type" => "add_menu_page_licence",
                "page_name" => __( "Catalog License", 'woocommerce-catalog-enquiry-pro' ),
                "menu_slug" => "mvx-license-admin",
                "layout" => "2-col"
                );
            ...
            */
            $woocommerce_catalog_options[ ] = array(
                "type" => "tab",
                "id" => "woo-catalog-pro-license-activation",
                "label" => __( "Activation", 'woocommerce-catalog-enquiry-pro' ),
                );
            ...
            $woocommerce_catalog_options[ ] = array(
                "type" => "section",
                "id" => $this->wc_am_activation_tab_key,
                "label" => __( "Common Settings pro ", 'woocommerce-catalog-enquiry-pro' ),
                );

            $woocommerce_catalog_options[ ] = array(
                "type" => "tab",
                "id" => "woo-catalog-pro-license-deactivation",
                "label" => __( "Deactivation", 'woocommerce-catalog-enquiry-pro' ),
                );

            // setting box
            $woocommerce_catalog_options[ ] = array(
                "type" => "setting",
                "id" => $this->wc_am_deactivate_checkbox_key,
                );

            $woocommerce_catalog_options[ ] = array(
                "type" => "section",
                "id" => $this->wc_am_deactivation_tab_key,
                );

            return $woocommerce_catalog_options;
        }
