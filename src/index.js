                  ...
                  <div className="inbox-msg">
                    <div className="inbox-people">
                      ...
                      {this.state.items.length > 0 ? this.state.items.map((student1, index1) => (
                        ...
                        <div className={`chat-list chat-list_${index1} ${this.state.open_enquiry_id === student1.enquiry_id ? 'active-product' : ''}`} 
                        onClick={(e) =>
                            this.woocommerce_catalog_enquiry_open_chat(
                                student1.to_user_id, student1.product_id, student1.enquiry_id, student1.current_user_id
                            )
                        }>
                            ...
                            <div className="chat-people">
                              ...
                              <div className="chat-ib">
...

                                {
                                    ...
                                    {/* {student1.last_massage} */}
                                <p className="admin-short-comming-msg"
                                        dangerouslySetInnerHTML={{
                              ...
                              <div className='chat-time'>{student1.enquiry_post_date}</div>
                ...
                <div className="chat-ib">
                   ...
                   {student2.enquiry_post_date}
                     ...
                     <p className="productDetailid">
                        <span>{student2.enquiry_post_title}
                        </span>
                    </p>
                </div>
              </div>
              ...
              <div className="customerTitleArea">
                ...
                <p className="productLink">
                  ...
                  <div className="cat-visiblity">
                    ...
                    { this.state.open_status_change_popup && Object.entries(student2.catalog_status).length > 0 ? Object.entries(student2.catalog_status).map(student4 => (
                        <>
                        <li>
                            <label>
